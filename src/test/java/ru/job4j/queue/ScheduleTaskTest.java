...
import ru.job4j.queue.task.ScheduleTask;
import ru.job4j.queue.task.Task;
import ru.job4j.queue.task.TaskByPositionAsc;
import ru.job4j.queue.task.TaskByUrgencyDesc;

import java.util.Comparator;

import static org.assertj.core.api.Assertions.assertThat;
import static ru.job4j.queue.task.Position.*;
